...
SECRET_KEY = 'django-insecure--t172p8fwh3myfimnz#&(d_)#w_rl$f2$_7^fbya7@rizep_x('
...
MIDDLEWARE = [
    ...
    'app_auth.middleware.RequestCounterMiddleware',
]
...
SIMPLE_JWT = config.SIMPLE_JWT_SETTINGS
